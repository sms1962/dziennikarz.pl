...
Remedium, miedzy innymi, na te problemy są tzw. generatory stron statycznych (static website generator). Technologia znana od dawna, ale usprawniona i wykorzystująca rozwój standardów internetowych, od kilku lat zdobywa coraz większą  popularność. Takim generatorem jest właśnie [Hugo](http://gohugo.com) na którym postawiłem tego blogaska. A dlaczego to o tym w dalszej części.
