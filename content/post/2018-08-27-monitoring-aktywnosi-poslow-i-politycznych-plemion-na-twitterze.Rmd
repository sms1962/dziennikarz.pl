---
title: Monitoring aktywnośi posłów i politycznych plemion na Twitterze
author: sms
date: '2018-08-27'
...
![Aktywnośc posłów na Twitterze, rano 27 sierpnia 2018](/post/2018-08-27-monitoring-aktywnosi-poslow-i-politycznych-plemion-na-twitterze_files/aktywnosc_poslow2018-08-27.png){width=80% height=80%}
...
Poniżej w interaktywnej tabeli przedstawiłem publikacje posłów PiS i PO w godzinach od 8 do 9, które możecie sobie przeglądnąć.
...
df %>% 
datatable(options = list(language = list(url = '//cdn.datatables.net/plug-ins/1.10.19/i18n/Polish.json')),
          escape = F)

```

UWAGA! W kolumnie *created_at* jest godzina czasu UTC (2h różnicy od naszego obecnego) jak oryginalnie podaje Twitter. Wystarczy dodać +2 godziny.

Interaktywna tabela umożliwia proste przeszukiwanie, a nawet podsumowywanie danych. Na przykład: 

- jeśli chcesz zobaczyć wszystkie publikacje posłów Platformy Obywatelskiej to w polu szukaj wpisz "PO". 
- jeśli chcesz wyświetlić tylko publikacje posła Sasina, to wpisz w polu szukaj "SasinJacek".

Zmienna *is_retweet* mówi czy dana publikacja jest tweetem (wartość false) czy retweetem (wartość true). Jeśli więc chcesz wyświetlić wszystkie tweety, wszystkich posłów to w polu szukaj wprowadź "false". 
...
Kiedy zrobiłem to narz○edzie, to odrazu nasunęło mi się pytanie: a gdyby tak móc podglądać zwolenników każdej partii na Twitterze? Dwa takie narzędzia dają już zdecydowanie lepszy obraz tego co się dzieje, bo widzimy np. reakcję partyjnych plemion na tweety polityków!  
